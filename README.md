...
- [x] List anything else that you can get done to improve the app functionality!
 - Network AlertController
 - You can search for anything in the search bar
 - Loading Image using PKHUD podfile 

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. How to implement using JSON
2. Better understanding of how to use the APIs from the yelp

## Video Walkthrough

Here's a walkthrough of implemented user stories:

![Imgur](https://i.imgur.com/Rh5P7BA.gif)
